<?php
	...
	$sql_cate = oci_parse($con,"SELECT * FROM SYS.tbl_category,SYS.tbl_sanpham WHERE tbl_category.category_id=tbl_sanpham.category_id AND tbl_sanpham.category_id='$id' ORDER BY tbl_sanpham.sanpham_id DESC");	
	oci_execute($sql_cate);
	$sql_category = oci_parse($con,"SELECT * FROM SYS.tbl_category,SYS.tbl_sanpham WHERE tbl_category.category_id=tbl_sanpham.category_id AND tbl_sanpham.category_id='$id' ORDER BY tbl_sanpham.sanpham_id DESC");		
oci_execute($sql_category);
	$row_title = oci_fetch_array($sql_category);
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
								<?php
								while($row_sanpham = oci_fetch_array($sql_cate)){ 
								?>
