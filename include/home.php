			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
                        ...
                        $sql_cate_home = oci_parse($con, 'SELECT * FROM tbl_category ORDER BY category_id DESC');
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
                                ...
                                // 	if($row_sanpham['category_id']==$id_category){
                                    $sql_product = oci_parse($con, 'SELECT * FROM tbl_sanpham ORDER BY sanpham_id DESC');
					...
					<div class="side-bar p-sm-4 p-3">
						<div class="f-grid py-2">
							...
							<div class="box-scroll">
								<div class="scroll">
									<?php
                                    $sql_product_sidebar = oci_parse($con, "SELECT * FROM tbl_sanpham WHERE sanpham_hot='0' ORDER BY sanpham_id DESC");
