		...
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					...
					<?php
					$sql_tendanhmuc = oci_parse($con,"SELECT * FROM SYS.tbl_danhmuc_tin WHERE danhmuctin_id='$id_danhmuc'");
...
<!-- about -->
	<div class="welcome py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<?php
			$sql1="SELECT * FROM SYS.tbl_danhmuc_tin WHERE danhmuctin_id='$id_danhmuc'";
			...
			<!-- //tittle heading -->
			<?php 
			$sql2="SELECT * FROM SYS.tbl_danhmuc_tin, SYS.tbl_baiviet WHERE tbl_danhmuc_tin.danhmuctin_id = tbl_baiviet.danhmuctin_id AND tbl_danhmuc_tin.danhmuctin_id='$id_danhmuc'";
